  ...
  const getCatBlogs = async () => {
    ...
    try {
      const res = await axios.get(
        `${vars.host}/api/category-book-admin/${cat}/`,
        { headers: headers }
      );
      setPage(res.data);
                          ...
                          return (
                            ...
                            >
                              ...
                              <td className="px-6 py-4 view">
                                <a target="_blank" href={`${post.bookPDF}`}>
                                  <svg
                              ...
                              <>
                                <td className="px-6 py-4 view">
                                  <Link to={`/admin/eb/edit/${post.bookSno}`}>
                              ...
                              <td className="px-6 py-4 delete">
                                <button
                                  onClick={() => deleteBook(post.bookSno)}
                                >
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 448 512"

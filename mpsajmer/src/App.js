              ...
              <BrowserRouter>
                <div className={`${mode}`}>
                  ...
                  <div className="main-cont flex">
                    ...
                    <div
                      className="right-body md:px-16 px-8 mt-12 w-screen h-screen py-24 md:inline-block overflow-y-scroll scroll-smooth bg-white dark:bg-gray-900 dark:text-white"
                      id="rightBody"
                    >
                      {/* <Modal /> */}
                      <Routes>

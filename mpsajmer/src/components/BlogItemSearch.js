              ...
              <div className="py-8 flex flex-wrap md:flex-nowrap w-[90%]">
                ...
                <div className="md:flex-grow">
                  ...
                  <Link
                    ...
                    className="text-blue-600 dark:text-purple-400 inline-flex items-center mt-4 cursor-pointer"
                  >
      ...
      <Link to={`/blog/${props.post.slug}`}>
        <div className="rounded-lg h-80 dark:bg-gray-800 bg-white shadow-2xl dark:shadow-none md:my-0 my-3 md:hover:scale-110 transition-all duration-200 cursor-pointer">
          ...
          <div className="text-content px-4 py-2">
            ...
            <div className="content text-justify dark:text-gray-400 text-gray-600 text-sm">
